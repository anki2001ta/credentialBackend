 ...
 */
const generateOrgResetPasswordToken = async (email) => {
...
const generateIndividualResetPasswordToken = async (email) => {
...
module.exports = {
  ...
  verifyToken,
  generateAuthTokens,
  generateIndividualResetPasswordToken,
  generateOrgResetPasswordToken,
